 ...
 * @author cx
 */
class CategorizedDesignPatternInfoImpl extends CategorizedDesignPatternInfo {
    ...
    private CategorizedDesignPatternInfoImpl(CategorizedDesignPatternInfoBuilder initializer) {
        ...
        this.patternInfo = getDesignPatternInfo(initializer);
    }

    private String patternName;
    private String patternCode;
    private String patternType;
    private DesignPatternInfo patternInfo;
    ...
    DesignPatternInfo getDesignPatternInfo() {
        return new DesignPatternInfoImpl(patternInfo.getUsageExample(), patternInfo.getDescription());
    }

    private DesignPatternInfo getDesignPatternInfo(CategorizedDesignPatternInfoBuilder initializer) {
        return new DesignPatternInfoImpl(initializer.patternExample, initializer.patternDescription);
    }
